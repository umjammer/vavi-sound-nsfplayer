...
public class PLSItem {
    ...
    public final int[] enable_vol = new int[4];
    public final int[] vol = new int[4];
...
A:
    ...
    public void set_title(CharSequence title) {
        if (title == null) {
            this.title = null;
            return;
        }
