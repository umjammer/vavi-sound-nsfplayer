...
public class NesDetectorEx extends NesDetector {
    ...
    public static final int
            SQR_0 = 0, // Rectangular wave 1
            SQR_1 = 1, // Rectangular wave 2
            TRI = 2, // triangle wave
            NOIZ = 3, // noise
            DPCM = 4,
            N106_0 = 5,
    ...
    protected final BasicDetector[] m_LD = new BasicDetector[MAX_CH];
    protected final boolean[] m_looped = new boolean[MAX_CH];
