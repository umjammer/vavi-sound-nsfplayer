...
public class SCC {
    ...
    /** unsigned */
    public final int[] incr = new int[5];

    public final int[][] wave = new int[5][32];

    /** unsigned */
    public final int[] count = new int[5];
    /** unsigned */
    public final int[] freq = new int[5];
    /** unsigned */
    public final int[] phase = new int[5];
    /** unsigned */
    public final int[] volume = new int[5];
    /** unsigned */
    public final int[] offset = new int[5];
    /** unsigned */
    public final int[] reg = new int[0x100 - 0xC0];
    ...
    public int refresh;
    public final int[] rotate = new int[5];
