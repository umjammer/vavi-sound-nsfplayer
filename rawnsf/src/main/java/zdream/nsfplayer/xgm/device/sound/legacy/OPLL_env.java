...
public class OPLL_env {
    ...
    public static final OPLL_env ins = new OPLL_env(); // instance
    ...
    public class OPLL {
        ...
        int opllstep;
        int prev, next;
        final int[] sprev = new int[2];
        final int[] snext = new int[2];
        /** unsigned */
        final int[] pan = new int[16];

        // Register
        /** unsigned */
        public final int[] reg = new int[0x40];
        final int[] slot_on_flag = new int[18];
        ...
        // Channel Data
        final int[] patch_number = new int[9];
        final int[] key_status = new int[9];

        /** Slot */
        public final OPLLSlot[] slot = new OPLLSlot[18];

        // Voice Data
        /** 19 x 2 = 38 */
        final OPLLPatch[] patch = new OPLLPatch[38];
    ...
    public static final class OPLLPatch {
    ...
    // Empty voice data
    final OPLLPatch null_patch = new OPLLPatch();
    ...
    public void writeReg(OPLL opll, int reg, int data) {
        ...
        switch (reg) {
            ...
            case 0x0e:
                ...
                for (int j = 0; j < 6; j++) {
                    OPLLSlot s = switch (j) {
                        case 0 -> opll.slot[6 << 1];
                        case 1 -> opll.slot[(6 << 1) | 1];
                        case 2 -> opll.slot[7 << 1];
                        case 3 -> opll.slot[(7 << 1) | 1];
                        case 4 -> opll.slot[8 << 1];
                        case 5 -> opll.slot[(8 << 1) | 1];
                        default -> null;
                    };
