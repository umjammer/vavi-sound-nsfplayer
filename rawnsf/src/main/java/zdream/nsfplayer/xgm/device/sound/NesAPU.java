...
public class NesAPU implements ISoundChip, IFrameSequencer, IDeviceValue {
    ...
    protected int mask;
    protected final int[][] sm = new int[2][2];

    protected int gclock; // unsigned
    protected final int[] reg = new int[0x20]; // unsigned byte
     ...
     * nonlinear mixer
     */
    protected final int[] square_table = new int[32];
    ...
    protected final boolean[] sweep_enable = new boolean[2];
    protected final boolean[] sweep_mode = new boolean[2];
    protected final boolean[] sweep_write = new boolean[2];
    protected final int[] sweep_div_period = new int[2];
    protected final int[] sweep_div = new int[2];
    protected final int[] sweep_amount = new int[2];

    protected final boolean[] envelope_disable = new boolean[2];
    protected final boolean[] envelope_loop = new boolean[2];
    ...
    protected final int[] envelope_counter = new int[2];

    protected final int[] length_counter = new int[2];

    protected final boolean[] enable = new boolean[2];

    protected final TrackInfoBasic[] trkinfo = new TrackInfoBasic[2];
