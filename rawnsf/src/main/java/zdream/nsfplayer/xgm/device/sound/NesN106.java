...
public class NesN106 implements ISoundChip, IDeviceValue {
    ...
    protected int mask;
    /** stereo mix */
    protected final int[][] sm = new int[2][8];
    /** current output */
    protected final int[] fout = new int[8];
    protected final TrackInfoN106[] trkinfo = new TrackInfoN106[8];
    protected final int[] option = new int[OPT_END];

    protected boolean master_disable;
    /** all state is contained here, unsigned */
    protected final int[] reg = new int[0x80];
    /** unsigned */
