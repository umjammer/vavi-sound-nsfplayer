...
public class NesFDS implements ISoundChip, IDeviceValue {
    ...
    protected int mask;
    /** stereo mix */
    protected final int[] sm = new int[2];
    /** current output */
    protected int fout;
    protected final TrackInfoFDS trkinfo;
    ...
    public void setRate(double r) {
        ...
        double cutoff = option[OPT_CUTOFF];
        double leak = 0.0;
        if (cutoff > 0)
    ...
    public int render(int[] bs) {
        ...
        int[] MASTER = {(int) ((MASTER_VOL / MAX_OUT) * 256.0 * 2.0f / 2.0f),
