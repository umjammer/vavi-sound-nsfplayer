...
public class BasicDetector implements ILoopDetector {
    ...
    protected final int m_bufmask;

    /**
     * <p>Used to record the most recent data written in memory and the location of the
     * </p>
     */
    private final int[] m_stream_buf;
    private final int[] m_time_buf;
    private int m_bidx;
    ...
    /**
     * Indicates whether data has been written to the entire Nes memory since it was reset.
     */
