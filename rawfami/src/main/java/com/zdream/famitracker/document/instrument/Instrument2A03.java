...
import static com.zdream.famitracker.FamitrackerTypes.NOTE_RANGE;
import static com.zdream.famitracker.FamitrackerTypes.OCTAVE_RANGE;
...
public class Instrument2A03 extends Instrument {
    ...
    private final byte[] m_iSeqEnable = new byte[SEQ_COUNT];
    private final int[] m_iSeqIndex = new int[SEQ_COUNT];

    /**
     * Samples
     */
    private final byte[][] m_cSamples = new byte[OCTAVE_RANGE][12];

    /**
     * Play pitch/loop
     */
    private final byte[][] m_cSamplePitch = new byte[OCTAVE_RANGE][12];

    /**
     * Loop offset
     */
    private final byte[][] m_cSampleLoopOffset = new byte[OCTAVE_RANGE][12];
