...
public class PatternData {
    ...
    private StChanNote getPatternData0(int channel, int pattern, int row) {
     ...
     */
    private final int[] m_iEffectColumns = new int[MAX_CHANNELS];

    /**
     * List of the patterns assigned to frames
     */
    private final int[][] m_iFrameList = new int[MAX_FRAMES][MAX_CHANNELS];

    /**
     * All accesses to m_pPatternData must go through GetPatternData()
     */
    private final StChanNote[][][] m_pPatternData = new StChanNote[MAX_CHANNELS][MAX_PATTERN][];
}
