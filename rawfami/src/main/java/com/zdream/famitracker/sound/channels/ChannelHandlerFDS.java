...
import static com.zdream.famitracker.FamitrackerTypes.EF_FDS_MOD_DEPTH;
import static com.zdream.famitracker.FamitrackerTypes.EF_FDS_MOD_SPEED_HI;
import static com.zdream.famitracker.FamitrackerTypes.EF_FDS_MOD_SPEED_LO;
...
public class ChannelHandlerFDS extends ChannelHandler {
    ...
    protected boolean handleInstrument(int instrument, boolean trigger, boolean newInstrument) {
        ...
        if (inst == null || !(inst instanceof InstrumentFDS pInstrument)) {
            return false;
        }
...
//			}
    ...
    // Modulation table
    protected final byte[] m_iModTable = new byte[32];
    protected final byte[] m_iWaveTable = new byte[64];
