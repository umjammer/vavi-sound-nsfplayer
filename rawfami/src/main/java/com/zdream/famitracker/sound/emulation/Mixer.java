...
import static com.zdream.famitracker.sound.emulation.Types.CHANID_S5B_CH1;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_S5B_CH3;
...
import static com.zdream.famitracker.sound.emulation.Types.CHANID_VRC7_CH1;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_VRC7_CH6;
...
public class Mixer {
    ...
    public Mixer() {
        ...
        synthFDS = new BlipSynth(12, -3500);
...
//		m_fLevelN163 = 1.0f;
    ...
    /**
     * @param lowCut     pSettings.sound.iBassFilter
     * @param highCut    pSettings.sound.iTrebleFilter
     * @param highDamp   pSettings.sound.iTrebleDamping
     * @param overallVol pSettings.sound.iMixVolume
     */
...
//		SynthN163.treble_eq(eq_n163);
        ...
        // FDS special filtering
        BlipEQ fds_eq = new BlipEQ(-48, 1000, m_iSampleRate, 0);
        synthFDS.trebleEq(fds_eq);
...
//		const float ATTENUATION_N163 = 0.70f;
        ...
        final float ATTENUATION_FDS = 0.90f;
...
//			Attenuation *= ATTENUATION_N163;
        ...
        if ((m_iExternalChip & SNDCHIP_FDS) != 0)
    ...
    // Blip buffer synths
    private final BlipSynth synth2A03SS;
    private final BlipSynth synth2A03TND;
    private final BlipSynth synthVRC6;
    private final BlipSynth synthMMC5; //	Blip_Synth<blip_good_quality, -130> SynthMMC5;
    //	Blip_Synth<blip_good_quality, -1600>	SynthN163;
    private final BlipSynth synthFDS; // Blip_Synth<blip_good_quality, -3500>	SynthFDS;

//	Blip_Synth<blip_good_quality, -2000>	SynthS5B;

    // Blip buffer object
    private final BlipBuffer blipBuffer = new BlipBuffer();

    private double m_dSumSS;
    private double m_dSumTND;

    private final int[] m_iChannels = new int[CHANNELS];
    ...
    private final float[] m_fChannelLevels = new float[CHANNELS];
    /**
     * unsigned
     */
    private final int[] m_iChanLevelFallOff = new int[CHANNELS];
