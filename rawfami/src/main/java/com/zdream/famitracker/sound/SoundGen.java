...
import static com.zdream.famitracker.FamiTrackerDoc.DEFAULT_SPEED;
import static com.zdream.famitracker.FamiTrackerDoc.DEFAULT_TEMPO_NTSC;
import static com.zdream.famitracker.FamitrackerTypes.EF_HALT;
...
public class SoundGen implements IAudioCallback {
    ...
    static final Logger log = Logger.getLogger("com.zdream.famitracker.sound.SoundGen");
...
//	DSoundChannel m_pDSoundChannel;
    ...
    final int[] m_iVibratoTable = new int[VIBRATO_LENGTH];
     ...
     */
    final boolean[] m_bFramePlayed = new boolean[MAX_FRAMES];
    ...
    final int[] m_iNoteLookupTableNTSC = new int[96]; // For 2A03
    final int[] m_iNoteLookupTablePAL = new int[96]; // For 2A07
    final int[] m_iNoteLookupTableSaw = new int[96]; // For VRC6 sawtooth
    final int[] m_iNoteLookupTableFDS = new int[96];    // For FDS
    final int[] m_iNoteLookupTableN163 = new int[96];     // For N163
...
//		}
        ...
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_APU1, pSettings.chipLevels.iLevelAPU1 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_APU2, pSettings.chipLevels.iLevelAPU2 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_VRC6, pSettings.chipLevels.iLevelVRC6 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_VRC7, pSettings.chipLevels.iLevelVRC7 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_MMC5, pSettings.chipLevels.iLevelMMC5 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_FDS, pSettings.chipLevels.iLevelFDS / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_N163, pSettings.chipLevels.iLevelN163 / 10.0f);
        m_pAPU.setChipLevel(Mixer.CHIP_LEVEL_S5B, pSettings.chipLevels.iLevelS5B / 10.0f);
...
//		assert(m_pTrackerView != null); // MFC 相关
    ...
    // TODO 暂时用于测试
    public final BytesPlayer player = new BytesPlayer();
