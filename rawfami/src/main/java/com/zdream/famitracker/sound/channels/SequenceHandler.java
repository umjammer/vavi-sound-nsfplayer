...
public abstract class SequenceHandler {
    ...
    // Sequence functions
    protected void setupSequence(int index, Sequence pSequence) {
    ...
    protected void runSequence(int index) {
        Sequence pSequence = m_pSequence[index];
     ...
     * @return
     */
    protected final boolean isSequenceEqual(int index, Sequence pSequence) {
    ...
    private void updateSequenceRunning(int index, Sequence pSequence) {
    ...
    private void updateSequenceEnd(int index, Sequence pSequence) {
        switch (index) {
            case SEQ_ARPEGGIO:
    ...
    private void releaseSequence(int index, Sequence pSeq) {
    ...
    // Sequence variables
    private final Sequence[] m_pSequence = new Sequence[SEQ_COUNT];
    private final int[] m_iSeqState = new int[SEQ_COUNT];
    private final int[] m_iSeqPointer = new int[SEQ_COUNT];
