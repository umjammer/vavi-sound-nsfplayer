...
public class APU {
    ...
    final byte[] m_iRegs = new byte[0x20];
...
//			m_iRegsFDS[Address - 0x4080] = Value;
    ...
    private final Mixer m_pMixer;
    private final IAudioCallback m_pParent;
    ...
    // Internal channels
    final Square m_pSquare1;
    final Square m_pSquare2;
    final Triangle m_pTriangle;
    final Noise m_pNoise;
    final DPCM m_pDPCM;
