...
public class MMC5 implements External {
    ...
    public int read(int address) {
        ...
        return switch (address) {
            case 0x5205 -> (m_iMulLow * m_iMulHigh) & 0xFF;
            case 0x5206 -> (m_iMulLow * m_iMulHigh) >> 8;
            default -> 0;
        };
    ...
    private final Square m_pSquare1;
    private final Square m_pSquare2;

    /**
     * uint8 *
     * <p>注意取数据时要转成非负数
     */
    private final byte[] m_pEXRAM;
