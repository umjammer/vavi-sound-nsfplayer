...
import static com.zdream.famitracker.FamitrackerTypes.EF_PITCH;
import static com.zdream.famitracker.FamitrackerTypes.EF_PORTAMENTO;
import static com.zdream.famitracker.FamitrackerTypes.EF_PORTAOFF;
import static com.zdream.famitracker.FamitrackerTypes.EF_PORTA_DOWN;
import static com.zdream.famitracker.FamitrackerTypes.EF_PORTA_UP;
import static com.zdream.famitracker.FamitrackerTypes.EF_SPEED;
import static com.zdream.famitracker.FamitrackerTypes.MAX_CHANNELS;
import static com.zdream.famitracker.FamitrackerTypes.MAX_DSAMPLES;
import static com.zdream.famitracker.FamitrackerTypes.MAX_EFFECT_COLUMNS;
import static com.zdream.famitracker.FamitrackerTypes.MAX_FRAMES;
import static com.zdream.famitracker.FamitrackerTypes.MAX_INSTRUMENTS;
import static com.zdream.famitracker.FamitrackerTypes.MAX_PATTERN;
import static com.zdream.famitracker.FamitrackerTypes.MAX_PATTERN_LENGTH;
import static com.zdream.famitracker.FamitrackerTypes.MAX_SEQUENCES;
import static com.zdream.famitracker.FamitrackerTypes.MAX_SEQUENCE_ITEMS;
import static com.zdream.famitracker.FamitrackerTypes.MAX_TEMPO;
import static com.zdream.famitracker.FamitrackerTypes.MAX_TRACKS;
import static com.zdream.famitracker.FamitrackerTypes.MAX_VOLUME;
import static com.zdream.famitracker.FamitrackerTypes.NTSC;
import static com.zdream.famitracker.FamitrackerTypes.PAL;
import static com.zdream.famitracker.FamitrackerTypes.SEQ_COUNT;
import static com.zdream.famitracker.FamitrackerTypes.VIBRATO_NEW;
import static com.zdream.famitracker.document.instrument.Instrument.INST_2A03;
import static com.zdream.famitracker.document.instrument.Instrument.INST_FDS;
import static com.zdream.famitracker.document.instrument.Instrument.INST_N163;
import static com.zdream.famitracker.document.instrument.Instrument.INST_S5B;
import static com.zdream.famitracker.document.instrument.Instrument.INST_VRC6;
import static com.zdream.famitracker.document.instrument.Instrument.INST_VRC7;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_DPCM;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_FDS;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_MMC5_SQUARE1;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_MMC5_SQUARE2;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN1;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN2;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN3;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN4;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN5;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN6;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN7;
import static com.zdream.famitracker.sound.emulation.Types.CHANID_N163_CHAN8;
...
import static com.zdream.famitracker.sound.emulation.Types.CHANNELS;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_FDS;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_MMC5;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_N163;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_NONE;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_S5B;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_VRC6;
import static com.zdream.famitracker.sound.emulation.Types.SNDCHIP_VRC7;
...
public class FamiTrackerDoc {
    ...
    public static int getChipFromInstrument(int type) {
        return switch (type) {
            case INST_2A03 -> SNDCHIP_NONE;
            case INST_VRC6 -> SNDCHIP_VRC6;
            case INST_VRC7 -> SNDCHIP_VRC7;
            case INST_S5B -> SNDCHIP_S5B;
            case INST_FDS -> SNDCHIP_FDS;
            case INST_N163 -> SNDCHIP_N163;
            default -> SNDCHIP_NONE;
        };
...
//		return static_cast<CFamiTrackerDoc*>(pFrame->GetActiveDocument());
    ...
    // Pattern editing
    public void setNoteData(int track, int frame, int channel, int row, StChanNote pData) {
        // TODO
    }
    ...
    public void setDataAtPattern(int track, int pattern, int channel, int row, StChanNote pData) {
        // TODO
    }
    ...
    public void setSongName(String pName) {
        m_strName = pName;
    }

    public void setSongArtist(String pArtist) {
        m_strArtist = pArtist;
    }

    public void setSongCopyright(String pCopyright) {
     ...
     * @param pName
     */
    public void setInstrumentName(int index, String pName) {
        // TODO
    }
    ...
    public final Instrument createInstrument(byte instType) {
        ...
        return switch (instType) {
            case INST_2A03 -> new Instrument2A03();
            case INST_VRC6 -> new InstrumentVRC6();
            case INST_VRC7 -> new InstrumentVRC7();
            case INST_N163 -> new InstrumentN163();
            case INST_FDS -> new InstrumentFDS();
            case INST_S5B -> null;
            default -> //return new CInstrumentS5B();
                    null;
        };
    ...
    public Sequence getSequence(int chip, int index, int type) {
        return switch (chip) {
            case SNDCHIP_NONE -> getSequence0(index, type);
            case SNDCHIP_VRC6 -> getSequenceVRC60(index, type);
            case SNDCHIP_N163 -> getSequenceN1630(index, type);
            case SNDCHIP_S5B -> null;
            default ->
...
//		m_strComment = pDocFile.readString();
     ...
     * @return
     */
    private PatternData getTrack1(int track) {
    ...
    private final byte[] m_iChannelTypes = new byte[CHANNELS];
...
//	private boolean m_bBackupDone;
     ...
     * List of all tracks
     */
    final PatternData[] m_pTracks = new PatternData[MAX_TRACKS];
    final String[] m_sTrackNames = new String[MAX_TRACKS];
    ...
    private final Instrument[] m_pInstruments = new Instrument[MAX_INSTRUMENTS];

    /**
     * The DPCM sample list
     */
    private final DSample[] m_DSamples = new DSample[MAX_DSAMPLES];

    private final Sequence[][] m_pSequences2A03 = new Sequence[MAX_SEQUENCES][SEQ_COUNT];
    private final Sequence[][] m_pSequencesVRC6 = new Sequence[MAX_SEQUENCES][SEQ_COUNT];
    private final Sequence[][] m_pSequencesN163 = new Sequence[MAX_SEQUENCES][SEQ_COUNT];
    private final Sequence[][] m_pSequencesS5B = new Sequence[MAX_SEQUENCES][SEQ_COUNT];
