...
/**
 * <p>The volume value setting parameter class for each channel
 * <p>Before this version, channel volume settings have been carried in the
 * configuration of each renderer, now it has been separated into a separate class.
 * </p>
 *
 * @author Zdream
 * @since v0.2.10
...
public class ChannelLevelsParameter implements Cloneable, Serializable {
    ...
    /**
     * Read from the specified instance and overwrite your own data
     */
