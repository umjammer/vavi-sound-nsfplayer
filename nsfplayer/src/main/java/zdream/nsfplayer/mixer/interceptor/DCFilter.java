...
/**
 * DC filter. Need to get the sampling rate (samples/second*track)
 *
 * @author Zdream
 * @since v0.2.3
 */
public class DCFilter implements ISoundInterceptor {
    ...
    public final void setParam(int r, int c) {
        ...
        // The following large text is copied from the original project NsfPlayer:
