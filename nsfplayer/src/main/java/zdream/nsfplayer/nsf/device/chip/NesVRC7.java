...
/**
 * VRC7 audio chip, manages the audio output of 6 VRC7 channels, from 1 to 6.
 *
 * @author Zdream
 * @since v0.2.7
 */
public class NesVRC7 extends AbstractSoundChip {
    ...
    private void writeReg(int data) {
        ...
        switch (reg) {
            ...
            case 0x25: {
                ...
                sound.carrierSlot.sustain = sustine;
    ...
    public AbstractNsfSound getSound(byte channelCode) {
        return switch (channelCode) {
            case CHANNEL_VRC7_FM1 -> opll.getSound(0);
            case CHANNEL_VRC7_FM2 -> opll.getSound(1);
            case CHANNEL_VRC7_FM3 -> opll.getSound(2);
            case CHANNEL_VRC7_FM4 -> opll.getSound(3);
            case CHANNEL_VRC7_FM5 -> opll.getSound(4);
            case CHANNEL_VRC7_FM6 -> opll.getSound(5);
            default -> null;
        };
    }
