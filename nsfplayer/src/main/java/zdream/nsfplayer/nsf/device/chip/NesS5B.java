...
/**
 * S5B audio chip, manages the audio output of three Sunsoft 5B tracks, numbered 1 through 3.
 *
 * @author Zdream
 * @since v0.2.8
 */
public class NesS5B extends AbstractSoundChip {
    ...
    public AbstractNsfSound getSound(byte channelCode) {
        return switch (channelCode) {
            case CHANNEL_S5B_SQUARE1 -> s1;
            case CHANNEL_S5B_SQUARE2 -> s2;
            case CHANNEL_S5B_SQUARE3 -> s3;
            default -> null;
        };
