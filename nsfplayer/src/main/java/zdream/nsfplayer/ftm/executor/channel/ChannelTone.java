...
/**
 * <p>Keyed tracks, including:
 * <li>2A03 Pulse, Triangle, Noise track;
 * <li>VRC6 Pulse, Sawtooth track; (not yet moved)
 * <li>MMC5 Pulse track; (not yet moved)
 * <li>FDS track; (not yet moved)
 * <li>N163 track;
 * <li>TODO Other tracks that support key processing
 * </li></p>
 *
 * @author Zdream
 * @since 0.2.5
